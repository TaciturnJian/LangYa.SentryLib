...
LangYa::SentryLib::LangYaConnection
::LangYaConnection(
...
void LangYa::SentryLib::LangYaConnection::HandleIO()
{
	if (IsWorking)
	{
...
LangYa::SentryLib::MemoryView::SizeType LangYa::SentryLib::LangYaConnection::Read(const MemoryView& view)
{
...
LangYa::SentryLib::MemoryView::SizeType LangYa::SentryLib::LangYaConnection::Write(const MemoryView& view)
{
...
void LangYa::SentryLib::LangYaConnection::Connect()
{
	SharedConnection->Connect();
}

bool LangYa::SentryLib::LangYaConnection::IsConnected()
{
	return SharedConnection->IsConnected();
}

void LangYa::SentryLib::LangYaConnection::Disconnect()
{
